...
- **(fix) Глава 8: Управління дефектами — Лінгвістичне вичитування (19 помилок виправлено)** 🔧
  - **Перша хвиля (12 помилок):**
    * Лексичні кальки: авдиторія→аудиторія, допускає→дозволяє, вислизає→виходить, сломалось→зламалось
    * Граматичні помилки: спостеріженням→спостереженням, ознака→ознаками
    * Активні дієприкметники: Сприяючі→Супутні, Коригуючі→Коригувальні
    * Синтаксис: вводить баг пароль→вводить некоректний пароль, не вирішуватиме його зараз→найближчим часом
    * Друкарські огріхи: coли→коли
  - **Друга хвиля (7 помилок) — формальна вичитування за переліком:**
    * Лексичні кальки: збиває дані→втрачає дані, вміст профілю→дані профілю залишаються видимими
    * Калькованість конструкцій: вплинута група→група користувачів, що зазнала впливу
    * Лексична неточність: витрата ресурсів→мале споживання ресурсів
    * Англіцизм: вільна→безкоштовна (5 екземплярів: Azure DevOps, Bugzilla×2, YouTrack, Trello)
    * Терміни QA: Мізерний рівень→Тривіальний рівень (стандартна QA-термінологія)
  - Результат: 100% лінгвістична чистота в Главі 8 (19 виправлень)
