...
- (docs) **Глава 3: Процеси та цикли тестування** (1045 рядків, v1.0 ЗАВЕРШЕНА)
  - 5 основних розділів (3.1-3.5) згідно HANDBOOK_STRUCTURE.md
  - 3.1: Фундаментальний процес тестування (6 фаз ISTQB v4.0)
  - 3.2: STLC — Цикл розвитку тестування (7 етапів)
  - 3.3: Критерії входу та виходу (Entry & Exit Criteria)
  - 3.4: Матриці в тестуванні (RTM, Coverage Matrix, Test Execution Matrix)
  - 3.5: Практичне завдання — Manual Testing та Test Case Design
  - 8+ детальних таблиць з прикладами та метриками
  - 2 Mermaid діаграми (6-фазовий процес, STLC-SDLC взаємозв'язок)
  - 6+ QR-кодів до освітніх ресурсів (ISTQB, STLC Video, stt-manual-testing)
  - 13+ GitHub URLs для посилань на dataset матеріали
  - 50+ практичних прикладів та case study з e-commerce сценарієм
  - 100% покриття вимог HANDBOOK_STRUCTURE.md
  - Консистентна українська мова без російських помилок
  - Алікація до ISTQB v4.0 стандартів

### Changed / Змінено

- (docs) Оновлено розділ 3 посібника з 136 рядків → 1045 рядків (7.7× збільшення обсягу)
