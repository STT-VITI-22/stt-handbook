...
- **(docs) Глава 7: Техніки тестування та дизайну — Версія 1.0 (Професійний тест з питаннями та завданнями)** ✨
  - (feature) **Основний файл:** `dist/Частина 2/Глава 7/Техніки тестування та дизайну.md` (2000+ рядків, перший повний випуск)
  ...
  - (feature) **GitHub URLs** на dataset файли (QALight, QA_Bible, книги)
