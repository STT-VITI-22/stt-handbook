...
| Підрозділ                                                   | Зміст | Джерела | Ресурси |
|-------------------------------------------------------------|-------|---------|----------|
| 7.1 Біла скринька: Тестування (White-box Testing)           | - Тестування внутрішньої структури, логіки та коду<br>- **Керуючий граф програми (Control Flow Graph - CFG)**<br>  - Графічне представлення потоку управління<br>  - Вузли та ребра, базові блоки коду<br>  - Характеристики CFG та застосування в тестуванні<br>- **Code Coverage (C0-C2)**<br>  - C0: Statement Coverage (всі оператори)<br>  - C1: Branch Coverage (всі розгалуження)<br>  - C2: Path Coverage (всі шляхи)<br>- **Цикломатична складність (McCabe Complexity)**<br>  - Формула: M = E − N + 2P<br>  - Застосування при оцінці тестування<br>  - Рекомендовані межи складності (≤10) | RWP ✓ / DATASET([QALight: white-black-grey-box-testuvannia](https://github.com/STT-VITI-22/stt-handbook/blob/main/dataset/articles/qalight/parsed/tipi-testuvannia/white-black-grey-box-testuvannia.md), QA_Bible: test-dizain) / MODERN(ISTQB 4.0) | ![QR: QALight](http://api.qrserver.com/v1/create-qr-code/?size=100x100&data=https://github.com/STT-VITI-22/stt-handbook/blob/main/dataset/articles/qalight/parsed/tipi-testuvannia/white-black-grey-box-testuvannia.md&margin=10) |
...
| 7.3 Сіра скринька: Тестування (Gray-box Testing)           | - Поєднання підходів білої та чорної скриньки<br>- Часткові знання про внутрішню структуру системи<br>- Фокус на взаємодії компонентів та API<br>- Тестування архітектури та інтеграцій<br>- Переваги гібридного підходу | RWP ✓ / DATASET([QALight: white-black-grey-box-testuvannia](https://github.com/STT-VITI-22/stt-handbook/blob/main/dataset/articles/qalight/parsed/tipi-testuvannia/white-black-grey-box-testuvannia.md)) / MODERN(ISTQB 4.0) |  |
| 7.4 Еквівалентне розділення (ECP)                           | - Розподіл вхідних даних на еквівалентні класи<br>- Валідні та невалідні партиції<br>- Практичні приклади (вік, ціна, стать)<br>- Зменшення кількості тест-кейсів без втрати покриття | RWP ✓ / DATASET([QALight: test-dizain-test-design](https://github.com/STT-VITI-22/stt-handbook/blob/main/dataset/articles/qalight/parsed/osnovi/test-dizain-test-design.md), QA_Bible: vidy-metody-urovni-testirovaniya) / MODERN ✓ |  |
| 7.5 Аналіз граничних значень (BVA)                          | - Тестування на межах діапазонів<br>- Off-by-one помилки та edge cases<br>- Мінімальні, нульові, граничні значення<br>- Таблиці граничних значень<br>- Комбінація з ECP | RWP ✓ / DATASET([QALight: test-dizain-test-design](https://github.com/STT-VITI-22/stt-handbook/blob/main/dataset/articles/qalight/parsed/osnovi/test-dizain-test-design.md), QA_Bible: vidy-metody-urovni-testirovaniya) / MODERN ✓ |  |
| 7.6 Таблиці рішень (Decision Table Testing)                 | - Структура таблиці рішень (умови та дії)<br>- Логічні комбінації умов та дій<br>- Оцінка правил та комбінацій<br>- Спрощення та мінімізація тестів | RWP ✓ / DATASET([QALight: test-dizain-test-design](https://github.com/STT-VITI-22/stt-handbook/blob/main/dataset/articles/qalight/parsed/osnovi/test-dizain-test-design.md), QA_Bible: vidy-metody-urovni-testirovaniya) / MODERN ✓ |  |
| 7.7 Тестування переходів стану (State Transition Testing)   | - Діаграми переходів стану (State Diagrams)<br>- Валідні та невалідні переходи<br>- Події та умови переходу<br>- Практичні приклади (UI workflows, замовлення)<br>- Таблиці переходів | RWP ✓ / DATASET([QALight: test-dizain-test-design](https://github.com/STT-VITI-22/stt-handbook/blob/main/dataset/articles/qalight/parsed/osnovi/test-dizain-test-design.md), QA_Bible: vidy-metody-urovni-testirovaniya) / MODERN ✓ |  |
| 7.8 Використання кейсів (Use Case Testing)                  | - Use Case описи та сценарії<br>- User Stories vs. Use Cases<br>- Happy path та exception paths<br>- Розроблення тест-кейсів з use cases<br>- Практичні приклади (замовлення, бронювання) | RWP ✓ / DATASET([QALight: test-dizain-test-design](https://github.com/STT-VITI-22/stt-handbook/blob/main/dataset/articles/qalight/parsed/osnovi/test-dizain-test-design.md), ISTQB 4.0) / MODERN ✓ |  |
| 7.9 Error Guessing (Вгадування помилок)                     | - Неформальний підхід на основі досвіду<br>- Припущення типових місць помилок<br>- Практичні приклади помилок (формати дат, NULL значення)<br>- Комбінування з іншими техніками | RWP ✓ / DATASET([QALight: osnovi/psikhologiia-testuvannia](https://github.com/STT-VITI-22/stt-handbook/blob/main/dataset/articles/qalight/parsed/osnovi/psikhologiia-testuvannia.md)) / MODERN ✓ |  |
| 7.10 Checklist-based Testing (Тестування на основі чек-листів) | - Попередньо підготовлені переліки перевірок<br>- Забезпечення повноти покриття<br>- Практичні приклади чек-листів<br>- Комбінування з іншими техніками | RWP ✓ / DATASET([QALight: checklists-dlia-testuvalnika](https://github.com/STT-VITI-22/stt-handbook/blob/main/dataset/articles/qalight/parsed/testovi-artefakti/checklists-dlia-testuvalnika.md)) / MODERN ✓ |  |
| 7.11 Exploratory Testing (ET) (Дослідницьке тестування)    | - Одночасне вивчення, проєктування та виконання тестів<br>- Session-based ET (Charter, Test, Debrief)<br>- **14 турів Вітакера** для ET<br>- ET в Agile (50-70% автотести, 30-50% ET)<br>- Знаходження непередбачених проблем | RWP ✓ / DATASET([QALight: osnovi/psikhologiia-testuvannia](https://github.com/STT-VITI-22/stt-handbook/blob/main/dataset/articles/qalight/parsed/osnovi/psikhologiia-testuvannia.md), [Gregory: Agile Testing](https://github.com/STT-VITI-22/stt-handbook/blob/main/dataset/books_pdf/parsed/Gregory_2014_AgileTesting(SPOILED_by_img_REMOVING).md)) / MODERN ✓ |  |

**Статус:** ✅ Глава 7 v1.3 (568 рядків, 11 розділів (7.1-7.11) - усі техніки тестування та дизайну з описами, прикладами та датасетом)
...
**Мета:** Глибоке розуміння особливостей тестування в гнучких методологіях розробки та практиках безперервної доставки

| Підрозділ | Зміст                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Джерела | Ресурси                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 9.1 Теоретичні основи Agile | - Ітеративно-інкрементні моделі розробки<br>- Agile як практична реалізація ітеративної моделі<br>- Agile Manifesto: 4 цінності та 12 принципів<br>- Тестування в Agile: Кардинальна зміна підходу                                                                                                                                                                                                                                                                                                                                                        | RWP ✓ / DATASET / MODERN(ISTQB 4.0) ✓ | [Agile-тестування. Навчальний курс для всієї команди. Gregory та Crispin](https://githubcom/STT-VITI-22/stt-handbook/blob/main/dataset/books_pdf/parsed/Gregory_2014_AgileTesting(SPOILED_by_img_REMOVING).md)<br>![QR: Gregory Crispin - Agile Testing](http://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://github.com/STT-VITI-22/stt-handbook/blob/main/dataset/books_pdf/parsed/Gregory_2014_AgileTesting(SPOILED_by_img_REMOVING).md&margin=10)                                                                                                                                                                                                                                                                                                                        |
| 9.2 Agile фреймворк Scrum | - Основні компоненти Scrum<br>-Діаграма згорання (Burndown Chart)<br>- Критика Scrum: Три глобальні проблеми впровадження                                                                                                                                                                                                                                                                                                                                                                                                                                 | RWP ✓ / DATASET / MODERN(ISTQB 4.0) ✓ | ![QR: Bug vs Issue](http://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://www.geeksforgeeks.org/software-testing/software-testing-bug-vs-defect-vs-error-vs-fault-vs-failure/&margin=10)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 9.3 LEAN методологія | - **5 принципів LEAN:** <br>- **Muda, Mura, Muri** концепції та взаємозв'язок<br>- **Kanban та WIP (Work in Progress) Limit**<br>- Поточні тенденції **Lean та Agile**<br> | RWP ✓ / DATASET / MODERN ✓ |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 9.4 DevOps та безперервне розгортання | - **DevOps як розширення Agile:** <br>- Розширені технічні навички **QA в контексті DevOps**| RWP ✓ / DATASET / MODERN ✓ |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 9.5 Практичні рекомендації та виклики Agile/DevOps тестування | -  Історична еволюція ролі QA<br>- QA та розробник — партнерство без конфліктів | RWP ✓ / MODERN ✓ | [Agile-тестування. Навчальний курс для всієї команди. Gregory та Crispin](https://github.com/STT-VITI-22/stt-handbook/blob/main/dataset/books_pdf/parsed/Gregory_2014_AgileTesting(SPOILED_by_img_REMOVING).md)<br>![QR: Gregory Crispin - Agile Testing](http://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://github.com/STT-VITI-22/stt-handbook/blob/main/dataset/books_pdf/parsed/Gregory_2014_AgileTesting(SPOILED_by_img_REMOVING).md&margin=10)<br>[Тестування програмного забезпечення. Навчальний посібник. Авраменко А.С., Авраменко В.С., Косенюк Г.В.](https://github.com/STT-VITI-22/stt-handbook/blob/main/dataset/books_pdf/parsed/Avramenko_2017_SoftwareTesting.md)<br> ![Тестування програмного забезпечення. Навчальний посібник. Авраменко А.С., Авраменко В.С., Косенюк Г.В.](http://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://github.com/STT-VITI-22/stt-handbook/blob/main/dataset/books_pdf/parsed/Avramenko_2017_SoftwareTesting.md&margin=10) |
...
- ✅ dist/Частина 2/Глава 5/Рівні тестування.md (1637 рядків, v2.0 — додано BDD розділ з 15 підсекціями, Gherkin приклади, Step Definitions, SMART критерії, Three Amigos принцип)
