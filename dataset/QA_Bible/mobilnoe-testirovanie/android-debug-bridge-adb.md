...
**Source:** https://vladislaveremeev.gitbook.io/qa_bible/mobilnoe-testirovanie/android/android-debug-bridge-adb
...
Чтобы начать работать с командами adb необходимо разрешить отладку по USB в настройках разработчика на телефоне. Где найти настройки разработчика смотрите в [Android Developer Settings](/qa_bible/mobilnoe-testirovanie/android/android-developer-settings.md). Если вы работаете с эмулятором из android studio, то отладка по USB будет включено по умолчанию.
...
<figure><img src="https://vladislaveremeev.gitbook.io/files/Ue1myXjM1ehRvBWeiW8J" alt="" width="375"><figcaption></figcaption></figure>
