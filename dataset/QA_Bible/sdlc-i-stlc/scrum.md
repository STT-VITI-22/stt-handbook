...
**Source:** https://vladislaveremeev.gitbook.io/qa_bible/sdlc-i-stlc/scrum
...
* [What is Scrum?](https://www.agilealliance.org/glossary/scrum/#q=~\(infinite~false~filters~\(postType~\(~'page~'post~'aa_book~'aa_event_session~'aa_experience_report~'aa_glossary~'aa_research_paper~'aa_video\)~tags~\(~'scrum\)\)~searchTerm~'~sort~false~sortDirection~'asc~page~1\))
...
* [Тесты должна писать разработка (?)](https://habr.com/ru/company/yandex_praktikum/blog/543262/)
