...
**Source:** https://vladislaveremeev.gitbook.io/qa_bible/avtomatizaciya-testirovaniya/osnovy/obshee
...
Автотесты станут гарантией, что ничего из старого не отвалилось, пока разработчики делали новые крутые штуки. Особенно, если эти новые штуки делались в совершенно других частях кода. Ручные регрессы, в данном случае, это, конечно, хорошо, но тут и человеческий фактор, и замыленный глаз, и непредсказуемость мест, в которых могут всплыть баги.

При этом ручное тестирование полностью никуда не уходит, так как новый функционал все еще будет проверяться руками. Нет смысла автоматизировать то, что возможно не взлетит и уже через неделю будет выпилено или отправлено на доработки.
...
## Можно ли писать один автотест сразу на обе платформы
...
## Как живется с автоматизированными регрессами

За два года, что мы живем с автоматизированным регрессом, у нас надежно устаканился недельный релиз-тест.
...
* [Святослав Куликов "Тестирование программного обеспечения. Базовый курс"](https://svyatoslav.biz/software_testing_book/). Раздел 3: Автоматизация тестирования
...
* [Введение в автоматизированное тестирование](https://www.youtube.com/watch?v=YLEhKE4vdHw) — базовое введение в автоматизацию тестирования
* [10 Tips You Should Read Before Automating Your Testing Work](https://www.softwaretestinghelp.com/10-tips-you-should-read-before-automating-your-testing-work/) — практические советы перед началом автоматизации
* [Manual And Automation Testing Challenges](https://www.softwaretestinghelp.com/manual-and-automation-testing-challenges/) — обзор проблем ручного и автоматизированного тестирования
* [How To Translate Manual Test Cases Into Automation Scripts?](https://www.softwaretestinghelp.com/how-to-translate-manual-test-cases-into-automation-scripts/) — руководство по конвертации ручных тестов в автотесты
* [Test Automation - Is It A Specialized Career?](https://www.softwaretestinghelp.com/test-automation-specialized-career/) — обсуждение карьерного пути в автоматизации тестирования
