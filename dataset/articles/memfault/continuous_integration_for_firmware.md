...
17 Sep 2019
by [François Baldassari](/authors/francois)
...
continuous integration has found its way into firmware projects[1](#fn:1).
...
This is the first post in our [Building Better Firmware series](/tag/better-firmware). Future posts will
...
* [Setting up CircleCI for a Firmware project](#setting-up-circleci-for-a-firmware-project)
  + [Setting the stage](#setting-the-stage)
  + [Creating a CircleCI Project](#creating-a-circleci-project)
  + [CircleCI Hello World](#circleci-hello-world)
  + [Testing CircleCI Configs Locally](#testing-circleci-configs-locally)
...
At Memfault, we use CircleCI[2](#fn:2) for continuous integration. It ticks all 4 of the
...
<https://github.com/memfault/ChibiOS>.

### Creating a CircleCI Project

We’re now ready to set up CircleCI. Head to <https://circleci.com>, create an account,
...
`checkout`[4](#fn:4) you can use which automatically does the right thing:
...
Now head to <https://circleci.com> and observe that a new job has started:
...
When adding to a Circle CI config, it’s often useful to test things out locally. This can easily be done using command line tool[5](#fn:6). For example:
...
API. More information can be found in their documentation[6](#fn:5)
...
1. For example, see [this post](http://www.cyrilfougeray.com/2020/10/03/firmware-qa-ci-cd.html) by an Equisense team member. [↩](#fnref:1)
2. [Circle CI](https://circleci.com) [↩](#fnref:2)
3. [Circle CI Documentation - Jobs, Steps, Workflows](https://circleci.com/docs/2.0/jobs-steps/#section=getting-started) [↩](#fnref:3)
4. [Checkout Step - CircleCI](https://circleci.com/docs/2.0/configuration-reference/#checkout) [↩](#fnref:4)
5. [CircleCI’s command-line application](https://github.com/CircleCI-Public/circleci-cli) [↩](#fnref:6)
6. [Storing Build Artifacts - CircleCI](https://circleci.com/docs/2.0/artifacts/) [↩](#fnref:5)

![](/img/author/francois.jpg)

[François Baldassari](/authors/francois) has worked on the embedded software teams at Sun, Pebble, and Oculus. He is currently the CEO of [Memfault](https://memfault.com).
