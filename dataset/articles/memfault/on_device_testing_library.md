...
07 Jun 2022
by [Jan Koniarik](/authors/veverak)
...
* [Design](#design)
  ...
  + [Reactor and Controller Working Together](#reactor-and-controller-working-together)
...
* [Controller is independent](#controller-is-independent)
...
The controller stores the data during test execution, and it is passed to the user once the test is done in test\_result.
...
[Jan Koniarik](/authors/veverak) -- robotics software engineer, keen interest in embedded, teaching assistant at university
