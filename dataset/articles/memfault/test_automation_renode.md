...
* [Automation Testing for Firmware](#automation-testing-for-firmware)
* [Using a Shell for Testing](#using-a-shell-for-testing)
* [Setup](#setup)
  + [Example Repo](#example-repo)
  + [Toolchain](#toolchain)
  + [Renode & Robot Framework](#renode--robot-framework)
  + [Docker](#docker)
* [Example Firmware Overview](#example-firmware-overview)
* [Anatomy of a Robot Framework Test](#anatomy-of-a-robot-framework-test)
* [More Robot Framework Tips & Tricks](#more-robot-framework-tips--tricks)
  + [Built-In Libraries](#built-in-libraries)
  + [UART Timeouts](#uart-timeouts)
  + [Regular Expressions on UART](#regular-expressions-on-uart)
  + [Comparison Operations](#comparison-operations)
  + [Line Endings](#line-endings)
  + [Tags & Documentation](#tags--documentation)
* [GitHub Actions CI & Renode](#github-actions-ci--renode)
  + [Building Firmware in CI](#building-firmware-in-ci)
  + [Running Renode in CI](#running-renode-in-ci)
  + [Complete GitHub Action `main.yml`](#complete-github-action-mainyml)
* [Debugging Failing Tests in CI](#debugging-failing-tests-in-ci)
* [Using Renode in Headless Mode](#using-renode-in-headless-mode)
...
boards is continually growing[1](#fn:renode_boards). Renode emulates many peripherals
...
Robot Framework[2](#fn:robot_framework). Robot Framework is most popular in the web
...
Firmware](/blog/firmware-shell#integration--automated-tests).
...
* GCC 8.3.1 / GNU Arm Embedded Toolchain as our compiler[3](#fn:gnu_toolchain)
...
> Want to learn more about Conda? Check out my previous post on using [Conda environments for embedded development](/blog/conda-developer-environments).
...
Shell](/blog/firmware-shell) post **much** easier. I’m glad
...
use the `DateTime` library[4](#fn:rf_datetime), you’d have to import it at the top of
your test suite.
...
CircleCI](/blog/continuous-integration-for-firmware). This
...
The beauty of this script is that it can be run locally *or* in a CI runner!
...
post](/blog/intro-to-renode#renode--integration-tests).
...
a file, and load it after-the-fact[5](#fn:renode_state_save) for postmortem debugging.
...
Projects](/blog/building-a-cli-for-firmware-projects), I
...
using Renode to test all aspects of the Memfault Firmware SDK[6](#fn:memfault_sdk).
...
1. [Renode Supported Boards](https://renode.readthedocs.io/en/latest/introduction/supported-boards.html) [↩](#fnref:renode_boards)
2. [Robot Framework](https://robotframework.org/) [↩](#fnref:robot_framework)
3. [GNU ARM Embedded toolchain for download](https://developer.arm.com/tools-and-software/open-source-software/developer-tools/gnu-toolchain/gnu-rm/downloads) [↩](#fnref:gnu_toolchain)
4. [Robot Framework - DateTime Library](https://robotframework.org/robotframework/latest/libraries/DateTime.html) [↩](#fnref:rf_datetime)
5. [Renode - State saving and loading](https://renode.readthedocs.io/en/latest/basic/saving.html) [↩](#fnref:renode_state_save)
6. [Memfault Firmware SDK](https://github.com/memfault/memfault-firmware-sdk) [↩](#fnref:memfault_sdk)
