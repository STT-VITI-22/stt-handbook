...
8 вебінарів
8 практичних артефактів
Курсовий Master Test Plan

Модуль 1: Фундамент Embedded QA та тестування логічних станів
...
Модуль 2: Протокольний аналіз та мікровідладка
...
**Вебінар 4. Протокольний аналіз I²C/SPI: робота з віртуальним логічним аналізатором**  
- шини I²C та SPI, принципи роботи логічного аналізатора й налаштування Logic Analyzer у Wokwi  
...
Модуль 3: Нефункціональні сценарії та автоматизація
...
Модуль 4: Мережевий IoT-рівень та фінальний запуск
