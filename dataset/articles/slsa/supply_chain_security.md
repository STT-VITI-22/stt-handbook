...
We talk about SLSA in terms of [tracks and levels](/spec/v1.0/levels).
A SLSA track focuses on a particular aspect of a supply chain, such as the Build
Track. SLSA v1.0 consists of only a single track ([Build](/spec/v1.0/levels#build-track)), but future versions of
...
to be possible in [future revisions](/spec/v1.0/future-directions).
...
* Producer trust: SLSA does not address organizations that intentionally
  ...
  or after the build, and [future SLSA tracks](/spec/v1.0/future-directions) intend to
...
[‹ What's new in v1.0](/spec/v1.0/whats-new)
[Supply chain threats ›](/spec/v1.0/threats-overview)
