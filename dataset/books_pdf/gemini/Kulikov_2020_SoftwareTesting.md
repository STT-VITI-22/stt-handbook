...
| Предметная область | Начальный уровень | Уровень младшего или среднего специалиста |
| :--- | :---: | :--- |
| \multicolumn{3}{|c|}{Операционные системы} |
...
| \multicolumn{3}{|c|}{Компьютерные сети} |
...
| \multicolumn{3}{|c|}{Веб-технологии} |
...
| \multicolumn{3}{|c|}{*И так далее — описание всех 23 найденных дефектов.*} |
...
| | | \multicolumn{2}{c|}{\textbf{Недопустимая длина}} | \multicolumn{2}{c|}{\textbf{Допустимая длина}} |
| :--- | :--- | :---: | :---: | :---: | :---: |
