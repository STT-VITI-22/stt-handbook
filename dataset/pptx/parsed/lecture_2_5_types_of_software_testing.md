# Лекція 2.5 ТТПЗ (Види тестування)

## Тема 2: Основи тестування програмного забезпечення

1. Рівні тестування
2. Види тестування
3. Класифікація тестування
4. Оцінка відтестованості проекту

## Рівні тестування (піраміда тестування)

![Піраміда тестування](images/lecture_2_5_types_of_software_testing/page_2_img_2.jpeg)
...
![Приймальне тестування](images/lecture_2_5_types_of_software_testing/page_3_img_2.jpeg)

Методи приймального тестування:

- Тестування замовником самостійно. Це ризиковано в тому плані репутаційних втрат.
- Тестування (Аудит) третьою стороною. Наймається спеціалізована компанія на тестуванні.
...
![Схема взаємодії модулів при системному тестуванні](images/lecture_2_5_types_of_software_testing/page_4_img_2.jpeg)
...
![Взаємодія модулів при інтеграційному тестуванні](images/lecture_2_5_types_of_software_testing/page_5_img_2.jpeg)
...
![Схема модульного тестування](images/lecture_2_5_types_of_software_testing/page_6_img_2.jpeg)

Основна ціль — пошук дефектів на рівні функцій, класів, модулів, бібліотек, які можуть бути протестовані окремо. Всі знайдені дефекти, як правило, виправляються в коді без формального їх опису в системі багів (Bug Tracking System).
...
![Види тестування](images/lecture_2_5_types_of_software_testing/page_7_img_2.jpeg)
...
![Порівняння ручного та автоматизованого тестування](images/lecture_2_5_types_of_software_testing/page_10_img_2.jpeg)
...
| Критерій | Ручне тестування ![Ручне тестування](images/lecture_2_5_types_of_software_testing/page_11_img_2.jpeg) | Автоматизоване тестування ![Автоматизоване тестування](images/lecture_2_5_types_of_software_testing/page_11_img_3.jpeg) |
| :--- | :--- | :--- |
...
![Графік залежності TV від часу](images/lecture_2_5_types_of_software_testing/page_12_img_2.jpeg)
...
![Модель КГП компонента G](images/lecture_2_5_types_of_software_testing/page_13_img_2.jpeg)
...
![Ієрархічна модель КГП компоненти G](images/lecture_2_5_types_of_software_testing/page_14_img_2.jpeg)

### Плоска модель КГП компоненти G

![Плоска модель КГП компоненти G](images/lecture_2_5_types_of_software_testing/page_14_img_3.jpeg)

### Ієрархічна модель КГП компоненти G1 та G2

![Ієрархічна модель КГП компоненти G1 та G2](images/lecture_2_5_types_of_software_testing/page_14_img_4.jpeg)
