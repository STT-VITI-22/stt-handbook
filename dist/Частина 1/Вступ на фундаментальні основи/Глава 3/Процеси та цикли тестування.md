...
**Посилання на джерела:** [Test Management в QA_Bible](../../../../../../dataset/articles/QA_Bible/obshee/protsess-testirovaniia-test-process-draft.md)
...
**Посилання на джерела:** [Test Environment в QA_Bible](../../../../../../dataset/articles/QA_Bible/obshee/testovaia-sreda-i-testovyi-stend-test-environment-test-bed.md)
...
### Exit Criteria Check:
- ✓ Всі 150 тестів виконані та зареєстровані
- ✓ 0 Critical (P1) дефектів залишилось
- ✓ 3 High (P2) дефектів: План на наступний sprint
- ✓ Покриття функцій: 97% (мета: 95%)
- ✓ Щільність дефектів: 0.32 на KLOC (межа: < 0.5)
- ✓ Менеджер проекту: ЗАТВЕРДИВ звіт

### Висновок:
Продукт готов до Production Release.
Залишкові ризики: Низькі (3 Medium дефекти можуть виправитись в 1.1)
```
...
## 3.5. Ролі та відповідальність у тестуванні

### 3.5.1. Ключові ролі

Сучасна QA-команда зазвичай складається з декількох спеціалістів, кожна з яких має чіткі обов'язки:

#### Test Taker (Manual QA / Software Tester)

**Обов'язки:**
- Виконання ручних тестових випадків
- Виявлення та документування дефектів
- Перетестування після виправлення розробниками
- Регресійне тестування перед релізом

**Вимоги до компетентності:**
- Розуміння процесів SDLC та STLC
- Навички критичного мислення та дизайну тестів
- Знання інструментів (JIRA, TestNG, API Postman)
- Комунікаційні навички

**Кар'єра:** Junior QA → QA Engineer → Senior QA → QA Lead
...
- Комунікація з іншими department (Dev, Product, DevOps)
- Звітування про якість продукту
- Прийняття рішень про готовність до релізу

**Вимоги:**
- 3-5+ років досвіду у тестуванні
- Лідерські та комунікаційні навички
- Глибокі знання ISTQB та інженерних практик
- Experience з управління проектами

#### Test Automation Engineer (AQA)

**Обов'язки:**
- Розроблення автоматизованих тестів
- Налаштування CI/CD pipeline
- Розроблення фреймворків та library
- Підтримання регресійних тестів
...
**Обов'язки:**
- Розроблення тестування як важливої частини розробки (не окремої від неї)
- Написання автоматизованих тестів, які інтегруються в розробку
- Розроблення та підтримання test infrastructure (libraries, tools, frameworks)
- Контрибютування в основну кодову базу разом з розробниками
- Участь у code reviews як для тестів, так і для development code

**Вимоги:**
- Експертне програмування (Java, Python, Go, C++)
- Глибоке розуміння архітектури та дизайну ПЗ
- Вміння писати чистий, масштабуємий код
- Менталітет розробника + знання тестування

**Різниця від AQA:**
- **AQA** — пише тести для перевірки функціоналу
- **SDET** — пише код, як розробник, щоб зробити тестування більш ефективним

#### Test Architect

**Обов'язки:**
- Проектування комплексної інфраструктури тестування
- Вибір та впровадження інструментів та фреймворків
- Розроблення стратегій та підходів до тестування на рівні організації
- Консультування інших ролей щодо best practices
- Вирішення архітектурних проблем у тестуванні
- Сертифікація та training інших QA-інженерів

**Вимоги:**
- 5-7+ років досвіду у тестуванні (переважно як Test Lead)
- Глибокі знання ISTQB та інженерних практик
- Архітектурне мислення та системний підхід
- Лідерські навички та комунікація

**Кар'єра:** Senior QA Engineer → QA Lead → Test Architect

#### Test Analyst / QA Analyst

**Обов'язки:**
- Аналіз вимог та проєктування тестів
- Розроблення сценаріїв та тестових випадків
- Визначення тестових даних та стратегії
- Підтримка трасування вимог (RTM)

**Вимоги:**
- Глибоке розуміння SDLC та бізнес-логіки
- Навички аналізу та документування
- Знання техніки тест-дизайну

**Посилання на джерела:** [QA Roles в QA_Bible](../../../../../../dataset/articles/QA_Bible/obshee/roli-dolzhnosti-v-komande.md)

### 3.5.2. RACI Matrix (Матриця відповідальності)

Визначає, хто **відповідальний (R)**, хто **затверджує (A)**, хто **консультує (C)** та кого **інформують (I)** при виконанні тестових видів діяльності:

| Діяльність | QA Engineer | Test Lead | Automation | Product Owner | DevOps |
|-----------|-------------|-----------|-----------|---|---|
| **Planning** | C | A,R | I | A | I |
| **Analysis & Design** | R | A | C | C | - |
| **Implementation** | R | A | R | - | C |
| **Execution** | R | I | R | - | - |
| **Defect Reporting** | R | A | C | C | - |
| **Exit Criteria Review** | C | R,A | - | A | - |
| **Env Setup** | - | I | C | - | R,A |
| **CI/CD Pipeline** | - | I | R | - | A |

**Легенда:**
- **R (Responsible)** — виконує роботу
- **A (Accountable)** — затверджує, приймає остаточне рішення
- **C (Consulted)** — надає поради, консультує
- **I (Informed)** — отримує інформацію про результати

### 3.5.3. Організаційні структури QA-команд

#### Модель 1: Централізована QA (Center of Excellence)
...
┌─── QA Director
    ...
    │   ├─── QA Engineer (Manual)
    │   └─── Automation Engineer
    ├─── QA Manager (Mobile Team)
    │   ├─── Senior QA Engineer
    │   └─── QA Engineer (Manual + Automation)
    └─── QA Manager (Infrastructure)
        ├─── Performance QA Engineer
        └─── Security QA Engineer
```

**Переваги:**
- Централізована стратегія якості
- Спеціалізація по технологіях та доменах
- Легше масштабуватися

**Недоліки:**
- Далеко від розробників
- Затримки в комунікації
- Опір змінам із боку команд

#### Модель 2: Decentralized QA (Embedded in Agile Teams)
...
┌─── Product Manager (PO)
    ...
    │   ├─── Developer
    │   └─── QA Engineer (embedded)
    └─── QA Coordination (center)
        └─── QA Lead (manages all QA engineers)
```

**Переваги:**
- QA з самого початку спринту
- Швидша комунікація з розробниками
- Культура якості в кожній команді

**Недоліки:**
- Складніше синхронізувати стратегію між командами
- Дублювання інструментів та процесів
- Вищі видатки на ресурси

---

## 3.6. Практичне завдання: Manual Testing та Test Case Design

### 3.6.1. Вступ до практичного проекту
...
| **Test Steps** | Послідовність дій, які виконує тестувальник | 1. Navigate to login page<br/>2. Enter email: user@test.com<br/>3. Enter password: Pass123!<br/>4. Click Login button |
...
### 3.6.3. Позитивне vs. Негативне тестування
...
### 3.6.3а. Серйозність та пріоритет дефектів (Defect Severity & Priority)
...
**Посилання на джерела:** [Defect Severity & Priority в QA_Bible](../../../../../../dataset/articles/QA_Bible/obshee/sereznost-i-prioritet-defekta-severity-priority.md)

---

### 3.6.4. Техніки Test Design та їх застосування
...
### 3.6.5. Виконання тестів та документування результатів
...
### 3.6.6. Регресійне тестування (Regression Testing)
...
Кожен раз, коли проводиться Release, запускаються ці 50 критичних тестів:

### Authentication Module (10 tests)
- ✓ TC-LOGIN-001: Valid login
- ✓ TC-LOGIN-003: Invalid password
- ✓ TC-LOGIN-004: Account lockout
- ✓ TC-SIGNUP-001: Valid registration
- ✓ TC-LOGOUT-001: Logout clears session
- ... (5 more)

### Core Transaction (15 tests)
- ✓ TC-TRANSFER-001: Basic transfer
- ✓ TC-TRANSFER-012: Daily limit
- ✓ TC-TRANSFER-015: Duplicate prevention
- ... (12 more)

### Reporting (10 tests)
- ✓ TC-REPORT-001: Generate monthly statement
- ✓ TC-REPORT-005: Export to PDF
- ... (8 more)

### Performance (5 tests)
- ✓ TC-PERF-001: Login response time <2s
- ✓ TC-PERF-003: Dashboard load <3s
- ... (3 more)
...
**Failure:** TC-PERF-001 (response time: 2.3s, exceeds 2s limit)
**Recommendation:** OK for release (within SLA tolerance)
```
...
**Посилання на джерела:** [Impact Analysis в QA_Bible](../../../../../../dataset/articles/QA_Bible/obshee/impakt-analiz-analiz-vliianiia-impact-analysis.md)

---

### 3.6.7. Root Cause Analysis (RCA) та Парето-аналіз
...
**Посилання на джерела:** [Root Cause Analysis в QA_Bible](../../../../../../dataset/articles/QA_Bible/obshee/analiz-pervoprichin-rca-root-cause-analysis.md)
...
- [Фундаментальний процес тестування](../../../../../../dataset/articles/qalight/parsed/osnovi/fundamentalnii-protses-testuvannia.md) — QALight базові концепції
- [Що таке тестування програмного забезпечення?](../../../../../../dataset/articles/qalight/parsed/osnovi/shcho-take-testuvannia-programnogo-zabezpechennia.md) — ISTQB v4.0 визначення
- [Коли починати та закінчувати тестування](../../../../../../dataset/articles/qalight/parsed/osnovi/koli-pochinati-ta-zakinchuvati-testuvannia.md) — Entry/Exit Criteria

### Матриці та артефакти

- [Матриця відповідності вимог (Requirements Traceability Matrix)](../../../../../../dataset/articles/qalight/parsed/osnovi/matritsia-vidpovidnosti-vimog-requirements-traceability-matrix.md) — RTM методологія
- [Матриця покриття та матриця відстеження](../../../../../../dataset/articles/qalight/parsed/osnovi/matritsia-pokrittia-i-matritsia-vidstezhennia.md) — Coverage та Execution matrices

### Test Design та ролі

- [Test Design (Тест дизайн)](../../../../../../dataset/articles/qalight/parsed/osnovi/test-dizain-test-design.md) — техніки та стратегії
- [Хто займається тестуванням?](../../../../../../dataset/articles/qalight/parsed/osnovi/khto-zaimaietsia-testuvanniam.md) — ролі та відповідальність

### Управління тестуванням (QA_Bible)

- [Test Management Process](../../../../../../dataset/articles/QA_Bible/obshee/protsess-testirovaniia-test-process-draft.md) — Planування та виконання тестування з діаграмами
- [QA Roles та позиції](../../../../../../dataset/articles/QA_Bible/obshee/roli-dolzhnosti-v-komande.md) — SDET та Test Architect ролі з изображениями
- [Test Environment Types](../../../../../../dataset/articles/QA_Bible/obshee/testovaia-sreda-i-testovyi-stend-test-environment-test-bed.md) — 5 типів тестових середовищ (Dev, Test, Integration, Preprod, Production)
- [Defect Severity & Priority](../../../../../../dataset/articles/QA_Bible/obshee/sereznost-i-prioritet-defekta-severity-priority.md) — Матриця Severity × Priority (16 комбінацій)
- [Impact Analysis](../../../../../../dataset/articles/QA_Bible/obshee/impakt-analiz-analiz-vliianiia-impact-analysis.md) — Методология аналізу впливу змін на регресійне тестування
- [Root Cause Analysis](../../../../../../dataset/articles/QA_Bible/obshee/analiz-pervoprichin-rca-root-cause-analysis.md) — RCA методолога з Pareto та Fishbone діаграмами
