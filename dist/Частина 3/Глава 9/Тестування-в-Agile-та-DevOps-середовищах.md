...
### Ітеративно-інкрементні моделі розробки (Авраменко, 2017)
...
>**Agile:** Комплексна методика організації процесу розробки програмного забезпечення, що включає сім'ю окремих підходів (фреймворків): Scrum, Kanban, Lean, XP, FDD та інші. Agile — це не просто набір практик, а **культурна трансформація**, яка змінює як людей взаємодіють, як розподіляються обов'язки, як приймаються рішення.
...
### Issue Tracking Systems (Bug Tracker Tools) в Agile 
...
### Історична еволюція ролі QA в Agile 
...
### Компетенції Agile QA: Т-подібний профіль

Gregory та Crispin вводят концепцію **"Т-подібного" профілю компетенцій** для успішного Agile QA спеціаліста:
