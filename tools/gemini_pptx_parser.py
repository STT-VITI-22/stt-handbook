...
NAME_PROMPT = """Проаналізуй перші слайди цієї презентації (лекції).
Згенеруй унікальну, URL-friendly назву файлу для неї. Формат: TopicName_LectureNumber.md
Не використовуй кирилицю (переклади або транслітеруй). Виведи ТІЛЬКИ назву файлу (без зайвого тексту)."""
